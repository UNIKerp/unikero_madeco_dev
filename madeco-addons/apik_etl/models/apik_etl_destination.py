...
class apik_etl_destination_ss_type(models.Model):
	_name = 'apik.etl.destination.ss_type'
	
	name = fields.Char('Nom')
	ttype = fields.Selection([('DB','DB'),('File','File'),('Mail','Mail'),('Manuel','Manuel'),('Odoo','Odoo'),('Python','Python')],string="Type",default='Python',required=True)
...
class apik_etl_destination(models.Model):
