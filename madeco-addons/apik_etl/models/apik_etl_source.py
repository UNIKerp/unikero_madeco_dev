...
class apik_etl_source_ss_type(models.Model):
	_name = 'apik.etl.source.ss_type'
	
	name = fields.Char('Nom')
	ttype = fields.Selection([('DB','DB'),('File','File'),('Manuel','Manuel'),('Odoo','Odoo'),('Python','Python')],string="Type",default='Python',required=True)
...
class apik_etl_source(models.Model):
