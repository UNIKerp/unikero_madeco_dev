odoo.define('stock_available_sale_stock.MontageWidget', function (require) {
    "use strict";
    ...
    var MontageWidget = Widget.extend({
        template: 'stock_available_sale_stock.Montage',
        ...
        async _openForecast(ev) {
            ev.stopPropagation();
            // TODO: in case of kit product, the forecast view should show the Montage 
        ...
        _getContent() {
            const $content = $(QWeb.render('stock_available_sale_stock.MontagePopOver', {
                data: this.data,
            }));
        ...
        //--------------------------------------------------------------------------
        /**
         * Set a bootstrap popover on the current Montage widget 
         */
        _setPopOver() {
    ...
    widget_registry.add('montage_widget', MontageWidget);
    
    return MontageWidget;
    });
